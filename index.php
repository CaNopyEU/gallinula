...
<section id="pricelist" class="main style2 secondary left dark fullscreen">
    <div class="content box style2">
        ...
        <p class="txtIntro">Ceník je velice individuální, <a href="#form" style="color: #98c593;">pro bližší informace
                ...
                <form action="<?= $_SERVER['REQUEST_URI']; ?>" name="myemailform" method="post">
                    <div class="fields">
                        ...
                        <div class="field half"><input type="email" name="email" placeholder="Email" id="formEmail"
                                                       maxlength="30" value="<?= (isset($_email) ? $_email : ''); ?>"/>
                        </div>
...
<script>
    ...
    function plusSlides(n) {
        console.log('plusSlide', slideIndex)
        showSlides(slideIndex += n);

    }

    function currentSlide(n) {
        console.log('current slide called')
        showSlides(slideIndex = n);
    }
    ...
    function modalImage(index, name) {
        var result = '<img class="slider-image" src="images/' + currentGallery.path + '/' + index + '">\n'
        document.getElementById("inner_image").innerHTML = result;
        console.log('result of modalImage', result)
    }
    ...
    function modalCounters() {
        ...
        var result = '<a class="prev" onclick="plusSlides(-1)">❮</a>\n' +
            '<a class="next" onclick="plusSlides(1)">❯</a>\n'
        console.log('modal Counters result', result)
        document.getElementById("modal_counters").innerHTML = result;
    }
    ...
    function showSlides(n, name) {
        ...
        if (name) {
            var slides = gallery[name].images  /*document.getElementsByClassName("mySlides");*/
            currentGallery = gallery[name];
            document.getElementById("image_slides").innerHTML = '';
            slides.forEach(modalSlides);
        }
        //var columns = slides.forEach(modalSlides);
        //console.log('colums', columns);

        console.log(name, 'loooog')
        ...
        console.log('hodnota N: ', n)
        var name_of_image = currentGallery.images[slideIndex - 1];
        console.log('name of image: ', name_of_image);
